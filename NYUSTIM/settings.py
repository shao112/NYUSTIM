"""
Django settings for NYUSTIM project.
...
SECRET_KEY = 'django-insecure-0c0paek7(rdwph%0r#+s1zdjy!xgv&gv+v2dwv3p@3dsgef7z-'
...
WSGI_APPLICATION = 'NYUSTIM.wsgi.application'
